  ...
  return (
    <div className="vt-page">
      <div className="animate-fade-in mb-8 flex items-center justify-between">
        <div>
          <p className="vt-label">Control Room</p>
          <h1 className="vt-title mt-1">Admin Dashboard</h1>
          <p className="vt-subtitle">System overview and management</p>
        </div>
      ...
      <div className="animate-fade-in mb-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {statCards.map((stat) => {
          ...
          return (
            <div key={stat.label} className="vt-card p-6">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-4xl font-bold leading-none text-[#131b2e]">{stat.value}</p>
                  <p className="vt-label mt-3">{stat.label}</p>
                </div>
      ...
      <div className="animate-fade-in grid gap-5 sm:grid-cols-2">
        <Link to="/admin/reports" className="vt-ai-card group p-6 transition-all hover:-translate-y-0.5">
        ...
        <Link to="/machines" className="vt-card group p-6 transition-all hover:-translate-y-0.5">
          <div className="flex items-center gap-4">
